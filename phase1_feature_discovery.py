...
SCIN_TO_SUBCATEGORY: dict[str, tuple[str, str]] = {
    "age_group_18_to_29":                       ("demographics_age", "20-30"),
    "age_group_30_to_39":                       ("demographics_age", "30-40"),
    "age_group_40_to_49":                       ("demographics_age", "40-50"),
    "age_group_50_to_59":                       ("demographics_age", "50-60"),
    "age_group_60_to_69":                       ("demographics_age", "60-70"),
    "age_group_70_to_79":                       ("demographics_age", "70-80"),
    "age_group_80_to_89":                       ("demographics_age", "80_plus"),
    "sex_female":                             ("demographics_sex", "female"),
    "sex_male":                             ("demographics_sex", "male"),
    "sex_other":                            ("demographics_sex", "other"),
    "fitzpatrick_skin_type_FST1":           ("demographics_skin_type", "fst1"),
    "fitzpatrick_skin_type_FST2":           ("demographics_skin_type", "fst2"),
    "fitzpatrick_skin_type_FST3":           ("demographics_skin_type", "fst3"),
    "fitzpatrick_skin_type_FST4":           ("demographics_skin_type", "fst4"),
    "fitzpatrick_skin_type_FST5":           ("demographics_skin_type", "fst5"),
    "fitzpatrick_skin_type_FST6":           ("demographics_skin_type", "fst6"),
